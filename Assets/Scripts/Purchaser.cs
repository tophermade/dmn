...
public class Purchaser : MonoBehaviour, IStoreListener
    {
        ...
        private static string kProductNameAppleNonConsumable = "dontmakenuggets.noads";      // Apple App Store identifier for the non-consumable product.
        ...
        private static string kProductNameGooglePlayNonConsumable = "dontmakenuggets.noads";     // Google Play Store identifier for the non-consumable product.
